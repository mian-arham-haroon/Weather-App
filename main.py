...
def getWeather():
    ...
    geolocator=Nominatim(user_agent="geoapiexericses")
    ...
    apikey="7ab842e32ff35851296182f2541c0de7"
    #wearher 
    api=(f"https://api.openweathermap.org/data/2.5/weather?{city}&appid={apikey}")
    json_data=requests.get(api).json
    condition=json_data['weather'][0]['main']
    description=json_data['weather'][0]['description']
    temp = int(json_data['main']['temp']-273.15)
    pressuer=json_data['main']['pressuer']
...
label1=Label(root,text="PREESER",font=("Helvetica",15,'bold'),fg="white",bg="#1ab5ef")
